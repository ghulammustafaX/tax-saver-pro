...
const TaxIllustrationUSA = () => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="houseGradientUSA" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#ffffff" stopOpacity="0.95" />
          <stop offset="100%" stopColor="#e5e7eb" stopOpacity="0.9" />
        </linearGradient>
        <linearGradient id="accentGradientUSA" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#dc2626" />
          <stop offset="100%" stopColor="#991b1b" />
        </linearGradient>
        <linearGradient id="blueAccentUSA" x1="0%" y1="0%" x2="100%" y2="100%">
      ...
      {/* Main house structure - American style */}
      ...
      {/* Floating document/assessment notice - animated */}
      <g className={`transition-all duration-1000 delay-700 ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
        ...
        {/* Checkmarks - USA style */}
        <g>
          <circle cx="95" cy="210" r="8" fill="#10b981" opacity="0.9"/>
          <path d="M 92 210 L 95 213 L 100 206" stroke="white" strokeWidth="2" fill="none"/>
          
          <circle cx="95" cy="240" r="8" fill="#10b981" opacity="0.9"/>
          <path d="M 92 240 L 95 243 L 100 236" stroke="white" strokeWidth="2" fill="none"/>
          
          <circle cx="95" cy="270" r="8" fill="#10b981" opacity="0.9"/>
      ...
      {/* Calculator/Assessment tool - animated */}
      ...
      {/* Stars - USA themed */}
      <g opacity="0.8">
        <path d="M 420 180 L 423 190 L 417 190 Z" fill="#2563eb"/>
        <path d="M 420 200 L 417 190 L 423 190 Z" fill="#2563eb"/>
        
        <path d="M 130 150 L 133 160 L 127 160 Z" fill="#dc2626"/>
        <path d="M 130 170 L 127 160 L 133 160 Z" fill="#dc2626"/>
      </g>
      ...
      <g className={`transition-all duration-1000 delay-1400 ${isVisible ? 'scale-100 opacity-100' : 'scale-0 opacity-0'}`} style={{ transformOrigin: '380px 180px' }}>
        <circle cx="380" cy="180" r="30" fill="#dc2626" opacity="0.9"/>
...
export default TaxIllustrationUSA;
